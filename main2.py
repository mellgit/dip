...
"""
Вход и выход, то есть таблица истинности логического элемента И-НЕ
Создание модели нейронных сетей
Добавить слои в модель
Скомпилируем модель нейронных сетей
Обучаем модель нейронных сетей
Тестируем вывод обученной нейронной сети на основе логического элемента NAND
сохранить модель как файл h5
"""